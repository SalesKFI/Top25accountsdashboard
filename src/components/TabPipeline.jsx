      ...
      {activeSection === 'overview' && (
        <div>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-2 mb-6">
            {[
              { label: 'Active Pipeline',    value: fmtM(activeRep==='All' ? 439614264 : totalActive), accent: true,  tip:`Sum of all open opportunity amounts in SF. Team total = $439.6M across 186 open opps` },
